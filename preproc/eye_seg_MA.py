...
path_save = '/home/dnr/Documents/data/eye_seg/training'
...
path_ma_imgs = join(path_ma, 'MA')
path_ma_healthy = join(path_ma, 'healthy')
...
# Crawl through MAs
list_pats = listdir(path_ma_imgs)
for name_pat in list_pats:
    path_imgs = join(path_ma_imgs, name_pat)
    path_anns = join(path_ma_anns, name_pat)
